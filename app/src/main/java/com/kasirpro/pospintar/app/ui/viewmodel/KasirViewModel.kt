package com.kasirpro.pospintar.app.ui.viewmodel

import android.app.Application
import androidx.lifecycle.AndroidViewModel
import androidx.lifecycle.viewModelScope
import com.kasirpro.pospintar.app.data.local.*
import com.kasirpro.pospintar.app.data.repository.*
...
class KasirViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val billingManager = com.kasirpro.pospintar.app.data.billing.BillingManager(application, repository)
    ...
    val codeRedeemResult = MutableStateFlow<com.kasirpro.pospintar.app.data.repository.RedeemResult?>(null)
    val isRedeemingCode = MutableStateFlow(false)

    fun redeemCode(code: String, expectedPackage: String? = null, expectedBillingCycle: String? = null, onComplete: (com.kasirpro.pospintar.app.data.repository.RedeemResult) -> Unit = {}) {
